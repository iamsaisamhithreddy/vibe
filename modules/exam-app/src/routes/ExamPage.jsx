...
import { Palette } from '../components/exam/Palette.jsx'
import { QuestionRenderer } from '../components/exam/QuestionRenderer.jsx'
import { Calculator } from '../components/exam/Calculator.jsx'
    ...
    <div className="flex min-h-screen flex-col bg-[#f0f4f8]" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className="flex items-center justify-between border-b border-gray-200 bg-white px-4 py-1">
        <div className="flex items-center">
          <div className="grid h-12 w-12 place-items-center rounded bg-[#5D54D5] text-xs font-bold text-white">
            GATE
          </div>
        </div>
        ...
        <div className="flex items-center">
          <div className="grid h-10 w-10 place-items-center rounded-full bg-gray-800 text-[10px] font-bold text-white">
            IITG
          </div>
        </div>
      </div>
      ...
      <div className="flex items-stretch border-b border-gray-300 bg-[#F3F3F3]" style={{ minHeight: 86 }}>
        ...
        <div className="flex items-center border-l border-gray-300 bg-white">
          <div className="flex h-full min-w-[150px] flex-col justify-center border-r border-gray-300 px-6 text-right">
            ...
            <div
              className="text-[22px] font-extrabold leading-none tracking-tighter text-gray-800"
          ...
          <div className="flex h-full items-center gap-3 bg-white px-4">
            <div className="grid h-[64px] w-[54px] shrink-0 place-items-center overflow-hidden border border-gray-400 bg-gray-100 p-[2px] text-xs text-gray-500 shadow-sm">
              PHOTO
            </div>
          ...
          <div className="flex justify-between gap-2 lg:col-span-3 lg:border-r lg:border-gray-300 lg:pr-4">
            <div className="flex flex-wrap gap-2">
              <button
                ...
                className="rounded-sm border border-gray-300 bg-white px-4 py-2 text-[13px] font-bold text-gray-700 hover:bg-gray-100"
              >
              ...
              <button
                ...
                className="rounded-sm border border-gray-300 bg-white px-4 py-2 text-[13px] font-bold text-gray-700 hover:bg-gray-100 disabled:opacity-50"
              >
                &lt;&lt; Previous
              </button>
            </div>
            <div>
              <button
                ...
                className="rounded-sm border border-[#1f6491] bg-[#287baf] px-4 py-2 text-[13px] font-bold text-white hover:bg-[#1f6491]"
              >
                Save &amp; Next
              </button>
            </div>
      ...
      {showCalc && (
        <div className="fixed left-8 top-24 z-50 w-[380px] rounded-md border border-gray-400 bg-[#dadada] shadow-2xl">
          <div className="flex items-center justify-between bg-[#5D54D5] px-3 py-1.5 text-white">
            ...
            <button onClick={() => setShowCalc(false)} className="text-lg">
              ×
            </button>
          </div>
          <div className="p-2">
...
function SummaryItem({ status, count, label }) {
  const shapes = {
    answered: {
      background: '#6DB825',
